...
# print error from this boot
alias error='journalctl -b -p err'
# incremental search of Local and Remote packages database, with detailed information on preview pane
...
# Arch updates
# export PATH="$HOME/.config/polybar/scripts/arch/scripts/arch:$PATH"
...
# pyenv activate ds-env 2>/dev/null

# Set shell options: http://zsh.sourceforge.net/Doc/Release/Options.html.
setopt glob_dots     # no special treatment for file names with a leading dot
setopt no_auto_menu  # require an extra TAB press to open the completion menu

export PATH=$PATH:/home/vinacio/.spicetify
